...
//           {[
//             { label: 'Total Applications', value: totalApplications, color: 'text-blue-400' },
//             { label: 'Total Interviews', value: totalInterviews, color: 'text-yellow-400' },
//             { label: 'Interview Rate', value: `${interviewRate}%`, color: 'text-yellow-600' },
//             { label: 'Offer Rate', value: `${offerRate}%`, color: 'text-green-400' },
//           ].map(({ label, value, color }) => (
//             <div key={label} className="glass-card p-4 rounded-md bg-gradient-to-tr from-gray-800 via-gray-900 to-black">
...
//           <div className="glass-card p-4 rounded-md bg-gradient-to-tr from-gray-800 via-gray-900 to-black">
//             <h3 className="text-lg font-semibold mb-4 text-white">Applications Over Time</h3>
...
//                   itemStyle={{ color: '#fff' }}
//                 />
//                 <Line type="monotone" dataKey="applications" stroke="#60a5fa" strokeWidth={3} dot={{ r: 3 }} />
//               </LineChart>
//             </ResponsiveContainer>
//           </div>

//           {/* Interview & Offers Tracking */}
//           <div className="glass-card p-4 rounded-md bg-gradient-to-tr from-gray-800 via-gray-900 to-black">
//             <h3 className="text-lg font-semibold mb-4 text-white">Interview & Offers Tracking</h3>
//             <ResponsiveContainer width="100%" height={300}>
//               <LineChart data={chartData}>
//                 <CartesianGrid strokeDasharray="3 3" stroke="#444" />
//                 <XAxis dataKey="date" stroke="#bbb" />
...
//                   height={36}
//                 />
//                 <Line type="monotone" dataKey="interviews" stroke="#f59e0b" strokeWidth={3} dot={{ r: 3 }} />
//                 <Line type="monotone" dataKey="offers" stroke="#10b981" strokeWidth={3} dot={{ r: 3 }} />
//               </LineChart>
//             </ResponsiveContainer>
//           </div>

//           {/* Daily Activity Summary (Bar Chart) */}
//           <div className="glass-card p-4 rounded-md bg-gradient-to-tr from-gray-800 via-gray-900 to-black lg:col-span-2">
//             <h3 className="text-lg font-semibold mb-4 text-white">Daily Activity Summary</h3>
//             <ResponsiveContainer width="100%" height={300}>
...
//                   itemStyle={{ color: '#fff' }}
//                 />
//                 <Legend wrapperStyle={{ color: '#eee' }} iconSize={12} verticalAlign="top" height={36} />
...
//           <div className="glass-card p-4 mt-4 text-center text-white/80">
//             <h3 className="text-lg">No analytics data available for the selected period</h3>
