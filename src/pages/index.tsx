        ...
        <div className="flex-1 px-3 sm:px-4 py-4 sm:py-6 space-y-6 md:space-y-8">
          ...
          <div className="relative overflow-hidden rounded-2xl md:rounded-3xl bg-gradient-to-br from-white/5 to-white/0 backdrop-blur-xl border border-white/10 shadow-2xl">
            ...
            <div className="relative p-4 md:p-6 lg:p-8">
              <div className="flex flex-row justify-between items-center gap-4 mb-6 md:mb-8 w-full whitespace-nowrap">
                ...
                <button
                  ...
                  className="group flex items-center gap-2 px-3 py-2 md:px-4 md:py-2 rounded-xl bg-white/5 hover:bg-white/10 text-white/70 hover:text-white transition-all duration-200 text-sm md:text-base"
                >
                  View all
